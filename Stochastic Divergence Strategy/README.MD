# 🚀 Stochastic Divergence Strategy — Pine Script Strategy
...
**Stochastic Divergence Strategy** is a Pine Script® strategy that trades **classic divergences** between price action and the **Stochastic Oscillator**.  
